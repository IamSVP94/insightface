...
new_img_dir_path = PARENT_DIR / 'temp' / f'df_bright_{bright_etalon}_0106_n_persons={len(df_persons)}_turn={turnmetric}_recog_tresh={recog_tresh}'
...
def persons_list_from_csv(df_persons):
    persons = []
...
#
all_persons = persons_list_from_csv(df_persons)
